...
export default function WebhooksPage() {
  ...
  return (
    <Box>
      ...
      <Table size="small">
        <TableHead><TableRow><TableCell>Event</TableCell><TableCell>Source</TableCell><TableCell>Status</TableCell><TableCell>Date</TableCell></TableRow></TableHead>
        <TableBody>
          {data.map((w) => (
            <TableRow key={w.id}>
          ...
          {data.length === 0 && <TableRow><TableCell colSpan={4} align="center">No webhooks</TableCell></TableRow>}
        </TableBody>
      </Table>
    </Box>
  );
